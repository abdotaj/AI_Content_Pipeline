"""run_fast_en.py — Fast pipeline, English only (test/isolation mode).
...
SAFETY:
  ...
  - Sends output to Telegram with [LANG TEST | FAST | ENGLISH] prefix
  - Failure here cannot affect existing production pipelines

Usage:
  python run_fast_en.py
  PIPELINE_MODE=fast python run_fast_en.py
"""
import os
...
if __name__ == "__main__":
    run_lang_pipeline("english", "fast")
