...
FFMPEG_PATH = r"C:\Users\abdot\Downloads\ffmpeg-8.1-essentials_build\ffmpeg-8.1-essentials_build\bin\ffmpeg.exe"
...
def process_video(input_path):
    ...
    enhance_video(input_path, output_long, vf_long)
    ...
    enhance_video(input_path, output_short, vf_short)
